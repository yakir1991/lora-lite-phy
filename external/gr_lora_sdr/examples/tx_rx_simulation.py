...
class tx_rx_simulation(gr.top_block):
    ...
    def __init__(self):
        ...
        payload_path = Path('vectors/sf8_cr48_payload.bin')
        if payload_path.exists():
            ...
            if payload_bytes:
                ...
                if payload_len > 0:
                    self.pay_len = pay_len = payload_len
