// Optimized and modernized the Workspace implementation for better readability and maintainability.
...
void Workspace::reset_debug_variables() {
...
void Workspace::allocate_buffers() {
    if (plan) {
        fft_destroy_plan(plan);
        plan = nullptr;
    }
...
void Workspace::create_fft_plan() {
...
void Workspace::generate_chirps() {
